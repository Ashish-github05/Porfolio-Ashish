...
const terminalLines = [
  ...
  { text: '  Stack   : React · NestJS · TypeScript · Node.js · MySQL', color: 'text-slate-300', delay: 1300 },
  ...
  { text: '', delay: 2700 },
  { text: '  React    ████████████ 75%', color: 'text-blue-400', delay: 2900 },
  { text: '  NestJS   ██████████░░ 70%', color: 'text-red-400', delay: 3100 },
  { text: '  Node.js  ███████████░ 80%', color: 'text-green-400', delay: 3300 },
  { text: '  MySQL   █████████░░░ 75%', color: 'text-cyan-400', delay: 3700 },
  { text: '', delay: 3700 },
